    ...
    <div class="buttons-container flex justify-between items-center mt-6">
        ...
        <div class="flex items-center space-x-4 ml-6">
            <div class="relative">
                ...
                <div class="hidden absolute z-10 w-104 mt-2 text-left font-semibold rounded-xl text-sml bg-white shadow-dialog">
                    <form action="#" method="post" class="space-y-4 px-4 py-6">
                        ...
                        <button type="button"
                                class="flex items-center text-white justify-center w-1/2 px-6 py-3 h-11 text-sm bg-x-blue font-semibold rounded-xl border border-x-blue
                                        transition ease-in duration-200 hover:bg-x-blue-hover">
                            Post Comment    
                        </button>
                        <button type="button"
                                class="flex items-center justify-center px-6 py-3 w-32 h-11 text-xs bg-gray-200 font-semibold rounded-xl border border-gray-200 
